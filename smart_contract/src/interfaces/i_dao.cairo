...
pub trait I_Dao<T> {
    ...
    fn create_proposal(ref self: T, claim_amount: u256, user_address: ContractAddress, image: ByteArray, claim_id: u128) -> bool;
    fn set_automobile_insurance_address(ref self: T, automobile_insurance_address: ContractAddress) -> bool;
    fn finalize_proposal(ref self: T, proposal_claim_id: u128) -> bool;
}